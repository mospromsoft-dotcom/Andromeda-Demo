...
При большом числе кораблей сокращены второстепенные огни и эффекты. Это первый этап улучшения глубины; новый свет и объёмные корпуса будут проверяться отдельно.
...
Файлы `Source code`, автоматически показанные GitHub в выпуске, содержат страницу этого репозитория. Сама игра находится в **Space2D-1.3.0-win64.zip**. Рядом с архивом опубликован `SHA256SUMS.txt`; `BUILD_INFO.json` внутри архива указывает версию и исходный commit сборки.
...
| Перебор перекрывающихся кораблей | Shift + ПКМ |
| Частицы скорости | F8: слабые / обычные / выкл. |
...
В секторе четыре станции, две планеты, 16 минеральных поясов, нейтральные корабли, имперская охрана и пираты. Есть торговля, ремонт, модульное оснащение и пять грейдов оборудования. Русский и английский интерфейс, тихий фон и радиопереговоры; настройки языка, звука и частиц сохраняются.
